...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Consulta el pais al que pertenece un Atleta
	 * 
	 * @param nombreAtleta nombre del atleta al que se desea realizar la consulta. 
	 *  @return pais nombre del pais al que pertenece dicho atleta 
	 */
